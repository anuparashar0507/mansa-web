...
const Contact = () => {
  return (
    <section className="dark:bg-dark relative z-10 flex w-full justify-center overflow-hidden bg-white py-20 lg:py-[120px]">
      <div className="container ">
        <div className="mx-auto flex flex-wrap lg:justify-center">
          <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              <span className="text-brand mb-2 block text-base font-semibold">
                Contact Us
              </span>
              <h2 className="text-dark mb-6 text-[32px] font-bold uppercase dark:text-black sm:text-[40px] lg:text-[36px] xl:text-[40px]">
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                <div className="bg-brand/5 text-brand mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]">
                  <svg
                    width="32"
                    height="32"
                    viewBox="0 0 32 32"
                ...
                <div className="w-full">
                  <h4 className="text-dark dark:text-brand mb-1 text-xl font-bold">
                    Our Location
                  </h4>
                  <p className="text-body-color dark:text-dark-6 text-base">
                    GB-11, A-BLOCK, MANSAROVER COMPLEX, BHOPAL
                  </p>
                </div>
              </div>
            ...
            <div className="dark:bg-dark-2 relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
              <form>
                ...
                <div>
                  <button
                    type="submit"
                    className="border-brand bg-brand w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
