...
const About: React.FC = () => {
  return (
    <div id="about" className="w-full overflow-hidden bg-white pb-12 pt-12 md:pt-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto my-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          ...
          <Image
            ...
            className="w-full max-w-none mx-auto rounded-xl ring-1 ring-blue-400/10 sm:w-[42rem] "
            width={1442}
            height={1442}
          />
        </div>
