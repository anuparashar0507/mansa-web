  ...
  return (
    <footer className="dark:bg-dark relative z-10 flex w-full flex-col justify-center bg-white pb-10 pt-20 lg:pb-20 lg:pt-[120px]">
            ...
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                <Link
                  ...
                  className="border-stroke text-dark hover:border-primary hover:bg-primary dark:border-dark-3 dark:hover:border-primary dark:text-brand mr-3 flex h-8 w-8 items-center justify-center rounded-full border hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="8"
                    height="16"
                ...
                <Link
                  href="javascript:void(0)"
                  className="border-stroke text-dark hover:border-primary hover:bg-primary dark:border-dark-3 dark:hover:border-primary borderhover:text-brand/80 dark:text-brand mr-3 flex h-8 w-8 items-center justify-center rounded-full sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="14"
                    height="14"
      ...
      <div className="bottom-0 flex w-full justify-center bg-slate-50 py-4">
        ...
        <Link href={"maverixtech.in"} target="_blank">
