...
const JobCard: React.FC<JobCardProps> = ({ jobData, handleClick }) => {
  ...
  // };
  return (
    <div className="card p-6 cursor-pointer bg-base-100 shadow-2xl border">
      <div onClick={() => handleClick(jobData)}>
        ...
        <div className="md:flex items-center  hidden">
          <div className="flex items-center">
            ...
            <span className="mr-3 text-gray-700 text-sm text-clip truncate max-w-full overflow-hidden">
