    ...
    <header className="bg-gray-50">
      ...
      >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <NavLink href="/about" title="About US" setMobileMenuOpen={setMobileMenuOpen} />
          <NavLink href="/events/karvan" title="Events" setMobileMenuOpen={setMobileMenuOpen} />
          <NavLink href="#" title="Gallery" setMobileMenuOpen={setMobileMenuOpen} />
          <NavLink href="/contact" title="Contact Us" setMobileMenuOpen={setMobileMenuOpen} />
        </Popover.Group>
...
const NavLink: React.FC<NavLinkProps> = ({ href, title, setMobileMenuOpen }) => {
  return (
    <Link
      href={href}
      onClick={() => setMobileMenuOpen(false)}
